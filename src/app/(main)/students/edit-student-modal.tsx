...
export default function EditStudentModal({ open, onClose, onSuccess, student }: EditStudentModalProps) {
  ...
  useEffect(() => {
    if (open) {
      ...
      setSelectedClass(student?.class || null)
      setError(null)
    }
  }, [open, student])
  ...
  const fetchClasses = async () => {
    try {
      ...
      if (student?.class) {
        const cls = json.classes.find((c: Class) => c.id === student.class.id)
